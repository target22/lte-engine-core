...
- Files extracted: **69**
- Skeleton payload: **138.8 KB**
- Source payload: **581.3 KB**
...
| `tests/test_layout_portable.py` | 10.7 KB | 2.0 KB | 19% |
...
| `tests/test_batch2.py` | 10.7 KB | 1.6 KB | 15% |
| `tests/test_draft.py` | 4.7 KB | 1.5 KB | 32% |
...
| `tests/test_pipeline.py` | 5.9 KB | 1.4 KB | 24% |
| `tests/test_graph_edges.py` | 5.6 KB | 1.3 KB | 23% |
| `lte/validators/compiler_parity.py` | 12.7 KB | 1.3 KB | 10% |
| `tests/test_round5.py` | 5.7 KB | 1.3 KB | 22% |
| `lte/cli/ingest.py` | 13.0 KB | 1.3 KB | 10% |
| `lte/validators/corpus.py` | 15.5 KB | 1.2 KB | 8% |
| `lte/cli/hooks/pre_commit.py` | 10.1 KB | 1.2 KB | 11% |
| `tests/test_payload_lock.py` | 5.0 KB | 1.1 KB | 23% |
| `tests/test_grammar_full.py` | 5.8 KB | 1.1 KB | 20% |
| `lte/runner/reporting.py` | 4.0 KB | 1.0 KB | 25% |
| `tests/test_engine.py` | 12.5 KB | 1.0 KB | 8% |
...
| `tests/test_pure_text.py` | 5.3 KB | 954 B | 18% |
...
| `tests/test_config_wiring.py` | 2.3 KB | 726 B | 31% |
| `lte/cli/ask.py` | 6.5 KB | 720 B | 11% |
| `lte/runner/__init__.py` | 2.2 KB | 709 B | 32% |
| `tests/fix_legacy_calls.py` | 4.3 KB | 699 B | 16% |
| `tests/test_projection.py` | 3.8 KB | 654 B | 17% |
| `lte/runner/config_schema.py` | 5.3 KB | 633 B | 12% |
| `lte/cli/lint.py` | 2.7 KB | 560 B | 20% |
| `tests/test_io_layer.py` | 3.0 KB | 532 B | 17% |
| `lte/io/graph_reader.py` | 1.4 KB | 503 B | 34% |
| `tests/signature_audit.py` | 3.4 KB | 474 B | 13% |
...
import pathlib
import sys
ARITY = { 'parse_text', 'parse_file', 'cached_or_parse', 'parse_image', 'reference_map', 'node_bodies', 'check_payload_lock', 'effective_statuses', ... +3 }  # dict, 11 key(s)
DELETED_CALLS = <set: 2 item(s)>
DELETED_ATTRS = <set: 9 item(s)>
...
import pathlib
import sys
EXPECTED = { 'parse_text', 'parse_file', 'cached_or_parse', 'parse_image', 'reference_map', 'node_bodies', 'check_payload_lock', 'effective_statuses', ... +4 }  # dict, 12 key(s)
GONE = <set: 5 item(s)>
def audit(roots):
    pass
...
try:
fm = <call: extract_frontmatter(...)>
md = <call: document_metadata_of(...)>
nodes, callouts = <call: parse_file(...)>
def parse_tree(grammar, directory, repo_root, glob):
    """(nodes, callouts) for every file matching `glob` under `directory`."""
    pass

n2, c2 = <call: parse_tree(...)>
docs = <call: list(...)>
bad_bytes = <expr>
try:
out = <list: 0 item(s)>
rc = <call: run(...)>
OPS_BAK = <call: read_text(...)>
out = <list: 0 item(s)>
        rc = <call: run(...)>
out = <list: 0 item(s)>
        rc = <call: run(...)>
...
out = <list: 0 item(s)>
        rc = <call: run(...)>
GRAPH = { 'vi', 'en' }  # dict, 2 key(s)
rows, details = <call: compare(...)>
pid, ovd, oed, mism, ova, oea = <expr>
gp = <expr>
out = <list: 0 item(s)>
same = { 'vi', 'en' }  # dict, 2 key(s)
out = <list: 0 item(s)>
r = <call: run(...)>
```
...
src = <call: source_of(...)>
t = <call: build_taxonomy(...)>
UI, GR = <tuple: 2 item(s)>
def wrapped(grammar):
    pass

class Good:
            dependent_lifecycle = { 'dependent_roles' }  # dict, 1 key(s)
...
lay = <call: ModuleType(...)>
normalize_rel = <expr>
CorpusLayout = <call: type(...)>
                                                 LayoutError = <call: type(...)>
PUBLIC_EXPOSURE = 'public'
...
src = <call: source_of(...)>
BAD = '!!! note "T"\n    body\n\n| a | b |\n|---|---|\n'
out = <call: check_banned_constructs(...)>
...
class Layout:
    ...
    def partition_of_path(self, p):
        pass

    def classify(self, p):
        pass

    def listing_suffixes(self):
        pass

    partitions = <tuple: 0 item(s)>
...
e, w, n, c = <call: _file_checks(...)>
banned = <expr>
e2, w2, n2, c2 = <call: _file_checks(...)>
...
raw_tax = <call: safe_load(...)>
raw_ui = <call: safe_load(...)>
raw_lr = <call: load(...)>
rows = <expr>
tax = <call: build_taxonomy(...)>
try:
g = <call: compile_grammar(...)>
try:
bad = <call: loads(...)>
try:
bad2 = <call: loads(...)>
...
priv = <list: 1 item(s)>
pub_c = <list: 1 item(s)>
priv_c = <list: 1 item(s)>
r1 = <call: build_renderer(...)>
                                 r2 = <call: build_renderer(...)>
a = <call: render(...)>
                                              b = <call: render(...)>
```

## `tests/test_grammar_full.py`
...
DOMAINS = <expr>
class Layout:
    locales = <tuple: 2 item(s)>
                            locales_suffixed = True
                                                     extensions = <tuple: 1 item(s)>

g = <call: compile_grammar(...)>
LEGACY = <list: 6 item(s)>
arp = <call: anchor_reference_pattern(...)>
bad = <call: deepcopy(...)>
try:
                                                    msg = None
bad = <call: deepcopy(...)>
...
DEP_ROLES = <tuple: 3 item(s)>
GRAPH_KEY = { 'debate', 'ops', 'evi' }  # dict, 3 key(s)
class Tax:
    dependent_roles = <expr>
    labels = { 'core' }  # dict, 1 key(s)
                               codeowners = { 'core' }  # dict, 1 key(s)
                                                               partition_scope = { 'core' }  # dict, 1 key(s)
    def contract_layer_of(self, pid):
        pass

    def callout_graph_key(self, role):
        pass
...
Info = <expr>
class Layout:
    locales = <tuple: 1 item(s)>
    def classify(self, rel):
        pass

    def partitions_for_target(self, s):
        pass

    def emitted_partitions_for_target(self, s):
        pass


MD = '# Pricing\n\n## Price bounds\nBids stay inside the band....'
REL = 'docs/public/core/01-price.contract.en.md'
diagnostics = <list: 0 item(s)>
graph = <call: build_lang_graph(...)>
nodes = <expr>
deb = <expr>
idx = <expr>
...
CFG = <expr>
EXAMPLES = <expr>
RESULTS = { 'pass', 'fail' }  # dict, 2 key(s)
LEGACY_SPLIT_DOCUMENT = '^(?P<slug>.+)\\.(?P<role>contract|debate|ops)\\.(?P<lang...'
def check(label, cond, extra=""):
    pass
...
work = <call: Path(...)>
DEFAULT = <call: load(...)>
A = <call: load_deployment(...)>
B = <call: load_deployment(...)>
L, G, T = <tuple: 3 item(s)>
expected = { 'docs/public/core/lte/01-pricing.contract.en.md', 'docs/public/core/lte/01-pricing.debate.vi.md', 'docs/public/core/legacy.en.md', 'docs/public/core/x/01-x.evi.en.md', 'docs/private/core-internal/sec/a/b.en.md', 'docs/public/core/README.md', 'docs/public/core/x.fr.md', 'docs/private/core/stray.en.md' }  # dict, 8 key(s)
public_rows = <expr>
nodes = <list: 3 item(s)>
calls = <list: 2 item(s)>
LA, GA, TA = <tuple: 3 item(s)>
pol = <call: classify(...)>
deb = <call: classify(...)>
LB, GB, TB = <tuple: 3 item(s)>
v = <call: classify(...)>
b_nodes = <list: 1 item(s)>
b_calls = <list: 2 item(s)>
BASE = <call: safe_load(...)>
ROLES = <expr>
...
parse_text = <expr>
normalize_status = <expr>
sm = <call: ModuleType(...)>
check_dependent_lifecycle = <expr>
import lte.engine as _e; _e.frontmatter, _e.state_machine = fm, sm
                         _, _ = <tuple: 2 item(s)>
from lte.engine import payload_lock as pl
g = <call: build(...)>
class Layout:
    def locale_of(self, rel):
        pass


C = '---\nstatus: "active"\nversion: "1.0.0"\n---\n## Price b...'
D = '---\nstatus: "active"\n---\n## Why not the median\nMean ...'
CP, DP = <tuple: 2 item(s)>
head = { <expr>, <expr> }  # dict, 2 key(s)
refs = <call: reference_map(...)>
MUT = <tuple: 1 item(s)>
ch = <call: Change(...)>
v = <call: check_payload_lock(...)>
v = <call: check_payload_lock(...)>
v = <call: check_payload_lock(...)>
v = <call: check_payload_lock(...)>
DEP = <call: replace(...)>
st = <call: effective_statuses(...)>
trans = <call: newly_invalidating(...)>
blocks = <call: check_atomic_deprecation(...)>
```
...
env = <call: resolve(...)>
cyc = <call: resolve(...)>
rec = <call: RecordingExecutor(...)>
out, emit = <call: sink(...)>
rc = <call: main(...)>
rec = <call: RecordingExecutor(...)>
out, emit = <call: sink(...)>
errbuf, eemit = <call: sink(...)>
rc = <call: main(...)>
rec = <call: RecordingExecutor(...)>
out, emit = <call: sink(...)>
errbuf, eemit = <call: sink(...)>
...
state_machine = <expr>
from lte.validators import draft
TYPO = '^legal-contracts-15a1-1501a2\n> [!refs-spec-lte-01-002] ...'
try:
    out = <call: check_likely_typos(...)>
                                             raised = None
BAD = '!!! note "T"\n    body\n\n| a | b |\n|---|---|\n'
FENCED = '```\n!!! note "shown as a migration example"\n| a | b |\...'
bc = <call: check_banned_constructs(...)>
src = <call: source_of(...)>
n, c = <call: parse_text(...)>
csrc = <call: source_of(...)>
_fn = <expr>
...
mod = <call: ModuleType(...)>
class Tax:
    dependent_roles = <tuple: 3 item(s)>
    def callout_graph_key(self, r):
        pass


G = { 'partitions' }  # dict, 1 key(s)
line = <call: _summarize_lang(...)>
psrc = <call: source_of(...)>
_top = <list: 0 item(s)>
gsrc = <call: source_of(...)>
````
